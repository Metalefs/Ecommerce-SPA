...
import { LerSobre } from 'apps/app-web/src/app/data/store/actions/sobre.actions';
import { CategoriaState, InformacoesContatoState, NavStateState, OrcamentoState, ProdutoState, SobreState } from 'apps/app-web/src/app/data/store/state';

import { EditarNavState } from 'apps/app-web/src/app/data/store/actions/navstate.actions';
...
import { LoginComponent } from 'apps/app-web/src/app/modules/login/page/login.component';
...
import { NavState, Link, NavLinksRes } from 'apps/app-web/src/app/shared/models/interfaces';
