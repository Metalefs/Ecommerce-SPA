...
import { CategoriaState, NavStateState } from 'apps/app-web/src/app/data/store/state';
import { NavState, GrupoNavLink, NavLink, NavLinks } from 'apps/app-web/src/app/shared/models/interfaces';
